    ...
    ReentrancyGuardUpgradeable
{
    ...
    */
    ...
    // ************************************** ADMIN FUNCTION **************************************
    /**
     * @notice Pause all core actions. Can only be called by admin.
     */
    ...
    /**
     * @notice Unpause all core actions. Can only be called by admin.
     */
    ...
    function deposit(
        uint256 _pid,
        uint256 _amount
    ) public whenNotPaused checkPid(_pid) nonReentrant {
    ...
    function unstake(
        uint256 _pid,
        uint256 _amount
    ) public whenNotPaused checkPid(_pid) whenNotWithdrawPaused nonReentrant {
        Pool storage pool_ = pool[_pid];
    ...
    function claim(
        uint256 _pid
    ) public whenNotPaused checkPid(_pid) whenNotClaimPaused nonReentrant {
        Pool storage pool_ = pool[_pid];
        User storage user_ = user[_pid][msg.sender];
